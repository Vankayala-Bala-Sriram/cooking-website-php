...
<head>
    ...
    <link rel="stylesheet" href="login_index.php">
...
<body>
    ...
    <section>
        <div class="container initial">
            <!--<img src="OG9KN00j-min.jpg">-->
            <h1 class="brand">
                <?php echo $user_data['user_name']; ?>, Learn a Recipe</h1>
            <form>
            ...
            <div class="search-result">
                <div class="item">
                    <img src="images/tortilla-wrap-with-falafel-fresh-salad-vegan-tacos-vegetarian-healthy-food_2829-6193.jpg" alt="">
